...
test_dct: tests/test_dct.c $(OBJ)
	$(CC) $(CFLAGS) tests/test_dct.c $(OBJ) -o test_dct test_quant test_e2e

test_quant: tests/test_quant.c $(OBJ)
	$(CC) $(CFLAGS) tests/test_quant.c $(OBJ) -o test_quant test_e2e

clean:
	rm -f $(OBJ) libcrap.a test_frame test_container test_bitstream test_colorspace test_dct test_quant test_e2e
